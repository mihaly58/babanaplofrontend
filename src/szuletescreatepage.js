...
export function SzuletesCreatePage() {
    ...
    const handleSubmit = async (event) => {
        ...
        const novekedesData = {
            ...
            felhasznaloId: localStorage.getItem("userid"),
        ...
        <div className='p-5 consent bg-whitesmoke text-center'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='form-group row pg-3'>
                    ...
                    <div className='col-sm-10'>
                        <input className='form-control' name='magassag' type='number' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Időpont</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='idopont' type='date' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Hely</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='hely' type='text' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Súly</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='suly' type='number' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Hossz</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='hossz' type='number' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Hajszin</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='hajszin' type='text' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Szemszin</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='szemszin' type='text' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Vércsoport</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='vercsoport' type='text' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Csillagjegy</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='csillagjegy' type='text' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
                    <label className='col-sm-2 col-form-label'>Születéstörténet</label>
                    <div className='col-sm-10'>
                        <input className='form-control' name='szuletestort' type='text' step='1' />
                    </div>
                </div>
                <div className='form-group row pg-3'>
